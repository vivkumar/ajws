...
<YYINITIAL> {
  "@Atomic"                    { return sym(Terminals.ATOMIC); }
  "@Atomicset"                 { return sym(Terminals.ATOMICSET); }
  "@AliasAtomic"               { return sym(Terminals.ALIASATOMIC); }
  "@NotAtomic"                 { return sym(Terminals.NOTATOMIC); }
}
