...
async {
				...
				final int offaa = offa;
                            	int idx1, idx2;
                                idx1 = 2 * k1;
                                idx2 = offaa + ((twon - idx1) % twon);
                                a[idx2] = a[offaa + idx1];
                                a[idx2 + 1] = -a[offaa + idx1 + 1];
                            }
            }
	}
            a[offa + n] = -a[offa + 1];
...
async {
	...
	final int offaa = offa;
                int idx1 = 2 * i;
                int idx2 = idx1 + 1;
                a[offaa + i] = bk1[idx1] * ak[idx1] - bk1[idx2] * ak[idx2];
            }
}
}
    }
...
async {
		...
		final int  offaa = offa;
		final int  n2a= n2;
                final int firstIdx = offaa + i * k;
                final int lastIdx = (i == (nthreads - 1)) ? offaa + n2a : firstIdx + k;
{
