...
public class pMOEAD extends Algorithm {
		...
		do {
			...
			Utils.randomPermutation(permutation, populationSize_);
					...
					for (int i = 0; i < populationSize_; i++) {
						parallel_execution(permutation, i);
					} // for 
	...
	private void parallel_execution(int[] permutation, int i) throws JMException, ClassNotFoundException {
	...
	public void initPopulation() throws JMException, ClassNotFoundException {
		...
		evaluate_problem_parallel(population_, 0, populationSize_);
	} // initPopulation
