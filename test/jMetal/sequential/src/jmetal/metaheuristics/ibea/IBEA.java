...
public class IBEA extends Algorithm{
  ...
  */
  ...
  double calcHypervolumeIndicator(Solution p_ind_a,
    ...
    else
    {
      ...
      {
    	  double v1 =0, v2 = 0;
    	  v1 = calcHypervolumeIndicator(p_ind_a, null, d - 1, maximumValues, minimumValues);
    	  v2 = calcHypervolumeIndicator(p_ind_a, p_ind_b, d - 1, maximumValues, minimumValues);
    	  volume = v1*((b - a) / r) + v2*((max - b) / r);
      }
      else
      {
  ...
  */
  public SolutionSet execute() throws JMException, ClassNotFoundException{
    ...
    evaluations = buildInitialSolSet_parallel(solutionSet, populationSize, false, evaluations);
