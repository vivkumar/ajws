...
import jmetal.experiments.studies.Directory;
...
public class dMOPSO extends Algorithm {
	 ...
	 * @throws JMException 
	 */
	private void computeSpeed(final int i) throws JMException{
		...
		// parallel part
				for (int var = 0; var < particle.size(); var++) {
					...
					computeVelocityConstriction(wmax, wmin, C1, C2,
							r1, r2, var, i, bestParticle, particle, bestGlobal, speed_);

		}
	} // computeSpeed
	
	private void computeVelocityConstriction(double wmax, double wmin, double C1, double C2,
			double r1, double r2, int var, int i, XReal bestParticle, XReal particle, XReal bestGlobal, double[][] speed) {
		try {
...
//			dataDirectory_ = "/home/juanjo/Dropbox/jMetalDropboxJuanjo/MOEAD_parameters/Weight";
			dataDirectory_ = Directory.outDir() + "/data/MOEAD_parameters/Weight";
