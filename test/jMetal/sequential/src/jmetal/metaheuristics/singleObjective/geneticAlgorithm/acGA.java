...
public class acGA extends Algorithm {
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    ...
    for (int i = 0; i < populationSize; i++){
      ...
      evaluations++;
    		...
    		for (int i = 0; i < populationSize; i++){
    			evaluate_parallel_internal(population, i);
    		}
  ...
  private void evaluate_parallel_internal(SolutionSet s, int index) throws JMException, ClassNotFoundException {
	  Solution solution = s.get(index);
	  problem_.evaluate(solution);  
	  solution.setLocation(index);
  }
} // acGA
