...
public class PAES extends Algorithm {        
  ...
  */    
  public SolutionSet execute() throws JMException, ClassNotFoundException {     
    int bisections, archiveSize, maxEvaluations;
    AdaptiveGridArchive archive;
    ...
    //Iterations....
    		for(int i=evaluations; i<maxEvaluations; i++) {
    			parallel_iterations(solution, mutationOperator, maxEvaluations, dominance, archive);
    		}
  ...
  private void parallel_iterations(Solution solution, Operator mutationOperator, int maxEvaluations, 
		  Comparator dominance, AdaptiveGridArchive archive) throws JMException, ClassNotFoundException {  
	  int flag;
	  ...
	  flag = dominance.compare(solution,mutatedIndividual);
//	  synchronized(this) {
		  // Check dominance
