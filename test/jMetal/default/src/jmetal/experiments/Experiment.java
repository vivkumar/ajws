...
public abstract class Experiment {
	...
	//Inicio modificacin ReferenceFronts
	public String[] frontPath_; // Path of each reference front file
	// Fin modificacin ReferenceFronts

	// Inicio modificacin planificacin Threads
	...
	// Fin modificacin planificacin Threads
	...
	public Experiment() {
		...
		algorithmIndex = 0;
		irunIndex = 0;
		// Fin modificacion planificacin Threads
	} // Constructor
	...
	public void runExperiment(int numberOfThreads) throws JMException, IOException {
		...
		// Fin modificacin planificacin Threads
		Settings.numberOfThreads_ = numberOfThreads;
		// warm up
		this.independentRuns_ = 1; // We are running 3 X 5 iterations.
		int iter=0;
		Thread[] p = new RunExperiment[numberOfThreads];
		for (int k = 0; k < numberOfThreads; k++) {
			//p[i] = new Experiment(map_, i, numberOfThreads, problemList_.length);
			p[k] = new RunExperiment(this, map_, k, numberOfThreads, problemList_.length);
			p[k].start();
		}
	...
	public void initExperiment(){
		...
		// Fin modificacin ReferenceFrons
	}
