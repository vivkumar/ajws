...
my $JASTADD= $ajws . "/src";
my $classpaths = "$JASTADD/AJWS.jar:$pwd/../jars/jksvm.jar:$pwd/lib/xpp3-1.1.4c.jar:.";
...
system("rm -rf $generated 2>/dev/null");
...
system("cat other_files.i | sed '/\.xml/d' > other_files.ii");
system("mv other_files.ii other_files.i");
...
system("cat steal_files.i | sed '/\.xml/d' > steal_files.ii");
system("mv steal_files.ii steal_files.i");
...
system("cp -rf $JASTADD/lib/ajws $generated/main/java/.");
